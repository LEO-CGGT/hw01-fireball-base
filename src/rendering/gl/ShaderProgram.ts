...
class ShaderProgram {
  ...
  unifFrenzy: WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifFrenzy = gl.getUniformLocation(this.prog, "u_Frenzy");
  ...
  setFrenzy(frenzy: number) {
    this.use();
    if (this.unifFrenzy !== -1) {
      gl.uniform1i(this.unifFrenzy, frenzy);
    }
  }
